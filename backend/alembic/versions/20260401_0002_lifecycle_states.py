...
def upgrade() -> None:
    # Create lifecycle state enum type (for PostgreSQL)
    # For SQLite, we'll just use VARCHAR
    
    # Create opportunity_lifecycle table
    op.create_table(
    ...
    # Create state milestones table (for progress tracking)
    op.create_table(
